...
class Task extends Model
{
     ...
     * @see \alphayax\freebox\api\v4\symbols\Download\Task\Type
     */
    protected $type;
    ...
    /**
     * @var string
     * @see \alphayax\freebox\api\v4\symbols\Download\Task\Status
     */
    protected $status;
    ...
    /**
     * @var string
     * @see \alphayax\freebox\api\v4\symbols\Download\Task\IoPriority
     */
    ...
    /** @var string : (only relevant for bt) torrent info_hash encoded in hexa) */
    protected $info_hash;

    /** @var int : (only relevant for bt) torrent piece length in bytes */
    protected $piece_length;
     ...
     */
    public function setPieceLength($piece_length)
    {
