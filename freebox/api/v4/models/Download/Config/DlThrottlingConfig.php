...
class DlThrottlingConfig extends Model
{
     ...
     * @see \alphayax\freebox\api\v4\symbols\Download\Config\DlThrottlingConfig\Schedule
     */
    protected $schedule = [];

    /**
     * @var string
     * @see \alphayax\freebox\api\v4\symbols\Download\Config\DlThrottlingConfig\Mode
     */
    protected $mode;
