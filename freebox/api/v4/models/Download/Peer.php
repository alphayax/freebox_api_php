...
class Peer extends Model
{
     ...
     * @see \alphayax\freebox\api\v4\symbols\Download\Peer\State
     */
    protected $state;

    /**
     * @var string (Read-only) : peer origin
     * @see \alphayax\freebox\api\v4\symbols\Download\Peer\Origin
     */
    protected $origin;

    /** @var
     * string (Read-only)
     * @see \alphayax\freebox\api\v4\symbols\Download\Peer\Protocol
     */
    protected $protocol;
